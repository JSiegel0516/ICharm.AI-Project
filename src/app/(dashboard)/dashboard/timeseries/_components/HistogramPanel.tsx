...
export function HistogramPanel({
  ...
  // Calculate histogram for selected dataset
  ...
  }, [chartData, selectedDatasetId, histogramData]);
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Distribution of values (no data available)
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-muted-foreground flex h-[300px] items-center justify-center text-sm">
            Select a dataset to view its distribution
          </div>
        </CardContent>
      </Card>
    );
              ...
              <Input
                ...
                onBlur={(e) => {
                  ...
                  if (value === "" || isNaN(parseInt(value))) {
                    setNumBins(20); // Reset to default
                  }
                }}
