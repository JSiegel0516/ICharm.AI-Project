...
async function generateEmbeddings() {
  ...
  for (const section of sectionsToEmbed) {
    console.log(`Embedding section: ${section.id} (${section.category || 'uncategorized'})`);
  ...
  fs.writeFileSync(outputPath, JSON.stringify({ sections: embeddedSections }, null, 2), 'utf8');
