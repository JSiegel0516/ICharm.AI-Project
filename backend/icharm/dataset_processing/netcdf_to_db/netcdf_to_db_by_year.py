...
class NetCDFtoDbYearlyFiles(NetCDFtoDbBase):
    ...
    def _process_multi_level_gridbox_data(
        ...
        # Find lat & lon axes
        try:
            lat_axis = name_to_axis[self.latitude_variable_name]
            lon_axis = name_to_axis[self.longitude_variable_name]
...
def main():
    if True:
        data_path = (
            "/home/jsiegel/projectCHARM/ICharm.AI-Project/backend/datasets/cmorph/daily"
        )
